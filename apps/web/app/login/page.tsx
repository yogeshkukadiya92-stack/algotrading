    ...
    <main className="flex min-h-screen items-center justify-center px-4 py-8">
      <div className="w-full max-w-5xl space-y-4">
        ...
        <div className="grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
          <section className="rounded-lg border border-border bg-slate-950 px-6 py-8 text-slate-50 shadow-lg">
            <div className="flex h-11 w-11 items-center justify-center rounded-md bg-primary text-primary-foreground">
              <BarChart3 className="h-5 w-5" />
            </div>
            <h1 className="mt-6 text-3xl font-semibold">TradePilot India</h1>
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-3">
              {[
                ...
                <div key={label} className="rounded-md border border-slate-800 bg-slate-900/70 p-4">
            ...
            <CardContent className="px-6 py-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">Use your TradePilot India account to enter the paper workspace.</p>
                </div>
                <Badge tone="red">
